                    ...
                    <div className='pt-12'>
                        ...
                        <div>
                            ...
                            <div className='flex items-center gap-4 mt-4'>
                                <Image className='w-12 h-12 rounded-full' src={author} alt='author' />
                                <div>

                                    <div className='font-bold text-on_light_text_gray dark:text-on_text_gray_2'>William Randolph</div>
                                    <div>
                                        <span className='text-sm text-on_light_text_gray mr-6 dark:text-on_text_gray_2'>25 April 2023</span>
