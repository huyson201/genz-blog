                 ...
                 md:px-24 lg:px-32 '>
                    <div className=' grid sm:grid-cols-2 gap-6 md:gap-24 lg:gap-32 border-b border-on_light_border_2 dark:border-on_dark_border pb-10 transition-colors'>
                        <div className='space-y-6'>
                            <Logo />
                            <p className='text-sm dark:text-on_dark_text_gray text-[#708ab0] '>When an unknown prnoto sans took a galley and scrambled it to make specimen book not only five When an unknown prnoto sans took a galley and scrambled it to five centurie.</p>
                            <div>
                        ...
                        <div>
                            <div className='text-on_light_text_white dark:text-on_dark_text_white mb-2  sm:my-10 sm:mt-0  sm:mb-8 text-[18px] '>Newsletter</div>
                            <p className='text-sm text-[#708ab0] dark:text-on_dark_text_gray mb-6 '>Sign up to be first to receive the latest stories inspiring us, case studies, and industry news.</p>
                    ...
                    <div className='mt-10 text-center md:text-left text-on_dark_text_gray dark:text-on_light_text_gray'>
